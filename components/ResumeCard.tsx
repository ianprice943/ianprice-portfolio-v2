...
const ResumeCard: React.FC<cardContent> = (cardContent) => {
    return (
        <article className="h-72 overflow-y-auto sm:h-56 md:h-72 lg:h-64 lg:overflow-y-auto shadow-lg mb-2 md:mr-4 rounded-xl p-4 lg:p-2 xl:p-4 border-gray-50 border-4 dark:bg-gray-600 dark:border-gray-600" tabIndex={0}>
