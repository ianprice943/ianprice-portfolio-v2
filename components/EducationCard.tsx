...
const EducationCard: React.FC<cardContent> = (cardContent) => {
    return (
        <article className="shadow-lg mb-2 rounded-xl p-2 border-gray-50 border-2  dark:bg-gray-600 dark:border-0 dark:border-gray-600">
            <h3 className="text-xl">{cardContent.school.schoolName}</h3>
